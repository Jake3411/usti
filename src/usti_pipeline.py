...
TYPE_CONTENT: List[Dict[str, Any]] = [
    {
        "cluster": 0,
        "code": "C0",
        "name": "自学学家（gpt's student）",
        "intro": "你有一颗向往自由的心，从迈入大学那一刻起，你就想好了要做自己时间的主人：课程表对你来说更像一个参考，而不是必须遵守的时间轴。你不太喜欢被统一节奏牵着走，更多时候会选择翘掉那些你觉得低效的课，把时间留给自己看网课和ppt、和 GPT 进行充满激情的学术探讨、或者按自己的兴趣深挖一两个主题。你很清楚自己在学什么、为什么要学这些，只是这个答案往往不是老师布置的作业，而是你心里默默规划的路线。在别人眼里，你可能像个「不上课还整天在电脑前晃悠」的摸鱼选手，但只有你自己知道：路漫漫其修远兮，吾将上下而求索。",
        "risks": "当你把重心放在自学和个体路线时，很容易和课程的节奏彻底脱节：错过了一些看起来「没什么用」但其实是基础的内容。你也可能因为不常去上课，导致对考试范围、作业要求、评分标准的理解出现偏差。长期下来，你的真实能力可能在稳步提升，但成绩单和老师对你的印象却有概率并不买账，这会让你产生一种微妙的挫败感——明明学了不少东西，却很难被体系看见。更隐蔽的风险在于，如果缺少自我约束，你的「自学时间」有时候会悄悄变成刷视频、刷社交的时间。要知道，自由和散漫之间只隔着一条很细的线。",
        "advice": "既然你已经选择走一条更偏自学的路径，那就试着把这条路走得更「专业」一点。你可以为自己设定一个最低对齐标准：搞清楚每门课的设计逻辑、核心考点、关键 ddl ，在此之上再自由安排自己的学习方式；定期用作业和考试当作「阶段测验」，检验一下自学的方向和深度有没有跑偏。同时，把 GPT 和各种在线资源当作合作伙伴，而不是替代品——先自己思考，再让工具帮你补盲点、查缺漏。只要你愿意在自由里加一点结构，在不从众走的同时，依然能拿到够好的学分和成绩，让「自学学家」这个身份既有理想主义的激情，也多了一点现实主义的护盾。",
    },
    {
        "cluster": 1,
        "code": "C1",
    ...
    },
    {
        ...
        "intro": "有人说你佛系，有人说你养生，但只有你自己知道——你就是爱睡觉罢了。你像一台会自动关机的电脑：一旦压力和疲劳积累到某个阈值，你的大脑会本能地按下休眠键，用一觉来替世界按下暂停。在这个快节奏的时代，你时常主动选择脱离人际网络与信息洪流，靠睡觉、发呆和放空把情绪慢慢消化。别人眼中的你或许「有点慢」「不够紧绷」，可你心里清楚：如果不先睡够那几个小时，接下来的任何努力都只是硬撑。",
        "risks": "当压力和疲劳累积时，选择睡一觉来「修复系统」，短期能让情绪缓一口气，但也容易把重要的任务和节奏一起按下暂停键。当真正身处紧急情况时，你可能在「睡一觉再说」和「事情越来越多」之间反复摇摆，最后变成睡得不少、却一直隐隐焦虑的状态。久而久之，你可能会更容易成为「低精力人群」中的一员，又说不清到底是自己太懒，还是天性使然。",
        "advice": "与其要求自己突然变成那种三小时睡眠的高能战士，不如先承认一件事：「我就是需要睡够一点，才有力气面对生活」，然后在这个前提下，把节奏设计得更聪明。比如，给自己设一个「最晚睡觉时间」和一个「最晚起床时间」，用固定的 7–8 小时睡眠当作硬边界，再把每天最清醒的那一小段时间留给最难啃的任务；同时，刻意把刷手机的时间压缩在几个短短的「奖励时段」，避免在床上无意识滑屏。这样你既保留了用睡眠自我修复的本能，又慢慢练习在清醒的那部分时间里，把生活和学习安排得更有掌控感。",
    },
    {
        "cluster": 6,
        "code": "C6",
...
def questionnaire_mapping(answer: Any, feature: str, quantiles: Dict[str, Dict[str, float]] | None = None) -> Any:
    ...
    if feature == "Sleep_Hours":
        level = map_level(
            {
                "A. 一般能保证 8–9 小时甚至更多睡眠，属于睡饱再战型。": 5,
